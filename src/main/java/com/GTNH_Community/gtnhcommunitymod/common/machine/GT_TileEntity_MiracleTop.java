...
import static com.GTNH_Community.gtnhcommunitymod.util.TextLocalization.Tooltip_MiracleTop_00;
import static com.GTNH_Community.gtnhcommunitymod.util.TextLocalization.Tooltip_MiracleTop_01;
import static com.GTNH_Community.gtnhcommunitymod.util.TextLocalization.Tooltip_MiracleTop_02;
import static com.GTNH_Community.gtnhcommunitymod.util.TextLocalization.Tooltip_MiracleTop_03;
import static com.GTNH_Community.gtnhcommunitymod.util.TextLocalization.Tooltip_MiracleTop_04;
import static com.GTNH_Community.gtnhcommunitymod.util.TextLocalization.Tooltip_MiracleTop_05;
import static com.GTNH_Community.gtnhcommunitymod.util.TextLocalization.Tooltip_MiracleTop_06;
import static com.GTNH_Community.gtnhcommunitymod.util.TextLocalization.Tooltip_MiracleTop_07;
...
import static com.GTNH_Community.gtnhcommunitymod.util.TextLocalization.textMiracleTopHatchLocation;
...
public class GT_TileEntity_MiracleTop extends GT_MetaTileEntity_ExtendedPowerMultiBlockBase<GT_TileEntity_MiracleTop>
    ...
    protected GT_Multiblock_Tooltip_Builder createTooltip() {
        ...
        tt.addMachineType(TextLocalization.Tooltip_MiracleTop_MachineType)
            .addInfo(Tooltip_MiracleTop_00)
            .addInfo(Tooltip_MiracleTop_01)
            .addInfo(Tooltip_MiracleTop_02)
            .addInfo(Tooltip_MiracleTop_03)
            .addInfo(Tooltip_MiracleTop_04)
            .addInfo(Tooltip_MiracleTop_05)
            .addInfo(Tooltip_MiracleTop_06)
            .addInfo(Tooltip_MiracleTop_07)
            .addInfo(StructureTooComplex)
            .addInfo(BLUE_PRINT_INFO)
            .addSeparator()
            .addController(textFrontCenter)
            .addInputHatch(textMiracleTopHatchLocation, 2)
            .addOutputHatch(textMiracleTopHatchLocation, 2)
            .addInputBus(textMiracleTopHatchLocation, 2)
            .addOutputBus(textMiracleTopHatchLocation, 2)
            .addMaintenanceHatch(textAroundController, 1)
            .addEnergyHatch(textMiracleTopHatchLocation, 2)

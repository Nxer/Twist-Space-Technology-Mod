...
@Mod(
    ...
    name = Tags.MODNAME,
    dependencies = "required-after:gregtech;"+"required-after:GoodGenerator;"+"required-after:miscutils;"+"required-after:bartworks;"+"required-after:ggfab;"+"required-after:Forestry;",

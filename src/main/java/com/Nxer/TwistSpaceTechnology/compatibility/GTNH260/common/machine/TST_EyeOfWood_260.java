...
public class TST_EyeOfWood_260 extends TST_EyeOfWood {

    // region Class Constructor
    public TST_EyeOfWood_260(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    private TST_EyeOfWood_260(String aName) {
        super(aName);
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new TST_EyeOfWood_260(this.mName);
    }
    // endregion

package com.Nxer.TwistSpaceTechnology.compatibility.GTNH260.common.machine;
...
import com.Nxer.TwistSpaceTechnology.compatibility.GTNH260.system.VoidMinerRework.logic.VoidMinerData;
import com.Nxer.TwistSpaceTechnology.compatibility.GTNH260.system.VoidMinerRework.logic.VoidMinerDataGenerator;
...
public class TST_StarcoreMiner_260 extends TST_StarcoreMiner {

    // region Class Constructor
    public TST_StarcoreMiner_260(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    private TST_StarcoreMiner_260(String aName) {
        super(aName);
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new TST_StarcoreMiner_260(this.mName);
    }

...
public class TST_EyeOfWood_261 extends TST_EyeOfWood {

    // region Class Constructor
    public TST_EyeOfWood_261(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    private TST_EyeOfWood_261(String aName) {
        super(aName);
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new TST_EyeOfWood_261(this.mName);
    }
    // endregion

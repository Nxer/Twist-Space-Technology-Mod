package com.Nxer.TwistSpaceTechnology.compatibility.GTNH261.common.machine;
...
public class TST_StarcoreMiner_261 extends TST_StarcoreMiner {

    // region Class Constructor
    public TST_StarcoreMiner_261(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    private TST_StarcoreMiner_261(String aName) {
        super(aName);
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new TST_StarcoreMiner_261(this.mName);
    }

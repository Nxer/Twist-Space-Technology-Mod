...
public class GTCMMachineRecipePool implements IRecipePool {
    ...
    public void loadRecipes() {
        ...
        GTValues.RA.stdBuilder()
            ...
            .metadata(SCANNING, new Scanning(1 * HOURS, TierEU.LV))
            .itemInputs(
                ItemList.Casing_Advanced_Iridium.get(1),
        ...
        GTValues.RA
            ...
            .metadata(SCANNING, new Scanning(640 * HOURS, TierEU.LV))
            .itemInputs(
                UXVTarget104.get(64),
        ...
        // region Astral Array
        {
            GTValues.RA
                ...
                .metadata(SCANNING, new Scanning(114514 * 20, TierEU.LV))
                .itemInputs(
        ...
        if(Config.Enable_IncompactCyclotron){
            ...
            GTValues.RA
                ...
                .metadata(SCANNING, new Scanning(4 * HOURS, TierEU.LV))
                .itemInputs(

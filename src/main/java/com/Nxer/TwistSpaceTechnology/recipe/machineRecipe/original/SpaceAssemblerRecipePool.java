...
public class SpaceAssemblerRecipePool implements IRecipePool {
    ...
    public void loadRecipes() {
...

        {
            ...
            TST_RecipeBuilder.builder()
                .itemInputs(
                    GTOreDictUnificator.get(OrePrefixes.plateDense, MaterialsUEVplus.SixPhasedCopper, 1),
                    ...
                    GTOreDictUnificator.get(OrePrefixes.screw, MaterialsUEVplus.MagnetohydrodynamicallyConstrainedStarMatter, 16))
                .fluidInputs(
            ...
            TST_RecipeBuilder.builder()
                .itemInputs(
                    GTOreDictUnificator.get(OrePrefixes.plateDense, MaterialsTST.AxonisAlloy, 1),
                    ...
                    GTOreDictUnificator.get(OrePrefixes.bolt, MaterialsUEVplus.MagnetohydrodynamicallyConstrainedStarMatter, 32))
                .fluidInputs(
            ...
            TST_RecipeBuilder.builder()
                .itemInputs(
                    ...
                    GTOreDictUnificator.get(OrePrefixes.screw, MaterialsUEVplus.MagnetohydrodynamicallyConstrainedStarMatter, 32))
                .fluidInputs(

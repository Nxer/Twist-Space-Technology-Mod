...
import static com.Nxer.TwistSpaceTechnology.common.recipeMap.GTCMRecipe.NeutronActivatorWithEURecipeMap;
...
public class NeutronActivatorWithEURecipePool {
    ...
    public static void loadRecipes() {
        ...
        for (GTRecipe recipeOrigin : neutronActivatorRecipes.getAllRecipes()) {
            ...
            NeutronActivatorWithEURecipeMap.addRecipe(recipeNew);
        }

...
public class RuneEngraverRecipePool implements IRecipePool {
    ...
    public void loadRecipes() {
        ...
        GT_Values.RA.stdBuilder()
            ...
            .fluidInputs(MaterialPool.LiquidMana.getFluidOrGas(3000))
            .itemOutputs(new ItemStack(ModItems.rune,2,9))
            .noFluidOutputs()
            .eut(RECIPE_IV)
            .duration(20 * 10)
            .addTo(RE);
        GT_Values.RA.stdBuilder()
            ...
            .fluidInputs(MaterialPool.LiquidMana.getFluidOrGas(3000))
            .itemOutputs(new ItemStack(ModItems.rune,2,10))
            .noFluidOutputs()
            .eut(RECIPE_IV)
            .duration(20 * 10)
            .addTo(RE);
        GT_Values.RA.stdBuilder()
            ...
            .fluidInputs(MaterialPool.LiquidMana.getFluidOrGas(3000))
            .itemOutputs(new ItemStack(ModItems.rune,2,11))
            .noFluidOutputs()
            .eut(RECIPE_IV)
            .duration(20 * 10)
            .addTo(RE);
        GT_Values.RA.stdBuilder()
            ...
            .fluidInputs(MaterialPool.LiquidMana.getFluidOrGas(3000))
            .itemOutputs(new ItemStack(ModItems.rune,2,12))
            .noFluidOutputs()
            .eut(RECIPE_IV)
            .duration(20 * 10)
            .addTo(RE);
        GT_Values.RA.stdBuilder()
            ...
            .fluidInputs(MaterialPool.LiquidMana.getFluidOrGas(3000))
            .itemOutputs(new ItemStack(ModItems.rune,2,13))
            .noFluidOutputs()
            .eut(RECIPE_IV)
            .duration(20 * 10)
            .addTo(RE);
        GT_Values.RA.stdBuilder()
            ...
            .fluidInputs(MaterialPool.LiquidMana.getFluidOrGas(3000))
            .itemOutputs(new ItemStack(ModItems.rune,2,14))
            .noFluidOutputs()
            .eut(RECIPE_IV)
            .duration(20 * 10)
            .addTo(RE);
        GT_Values.RA.stdBuilder()
            ...
            .fluidInputs(MaterialPool.LiquidMana.getFluidOrGas(3000))
            .itemOutputs(new ItemStack(ModItems.rune,2,15))
            .noFluidOutputs()
            .eut(RECIPE_IV)
            .duration(20 * 10)
            .addTo(RE);

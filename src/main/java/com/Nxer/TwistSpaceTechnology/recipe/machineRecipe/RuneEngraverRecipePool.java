...
public class RuneEngraverRecipePool implements IRecipePool {
    ...
    public void loadRecipes() {
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(new ItemStack(ModItems.rune,4,0))
            .noFluidOutputs()
            .eut(RECIPE_EV)
            .duration(20 * 10)
            .addTo(RE);
        GT_Values.RA.stdBuilder()
            ...
            .fluidInputs(MaterialPool.LiquidMana.getFluidOrGas(2000))
            .itemOutputs(new ItemStack(ModItems.rune,4,1))
            .noFluidOutputs()
            .eut(RECIPE_EV)
            .duration(20 * 10)
            .addTo(RE);
        GT_Values.RA.stdBuilder()
            ...
            .fluidInputs(MaterialPool.LiquidMana.getFluidOrGas(2000))
            .itemOutputs(new ItemStack(ModItems.rune,4,2))
            .noFluidOutputs()
            .eut(RECIPE_EV)
            .duration(20 * 10)
            .addTo(RE);
        GT_Values.RA.stdBuilder()
            ...
            .fluidInputs(MaterialPool.LiquidMana.getFluidOrGas(2000))
            .itemOutputs(new ItemStack(ModItems.rune,4,3))
            .noFluidOutputs()
            .eut(RECIPE_EV)
            .duration(20 * 10)
            .addTo(RE);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(new ItemStack(ModItems.rune,2,4))
            .noFluidOutputs()
            .eut(RECIPE_EV)
            .duration(20 * 15)
            .addTo(RE);
        GT_Values.RA.stdBuilder()
            ...
            .fluidInputs(MaterialPool.LiquidMana.getFluidOrGas(1500))
            .itemOutputs(new ItemStack(ModItems.rune,2,5))
            .noFluidOutputs()
            .eut(RECIPE_EV)
            .duration(20 * 15)
            .addTo(RE);
        GT_Values.RA.stdBuilder()
            ...
            .fluidInputs(MaterialPool.LiquidMana.getFluidOrGas(1500))
            .itemOutputs(new ItemStack(ModItems.rune,2,6))
            .noFluidOutputs()
            .eut(RECIPE_EV)
            .duration(20 * 15)
            .addTo(RE);
        GT_Values.RA.stdBuilder()
            ...
            .fluidInputs(MaterialPool.LiquidMana.getFluidOrGas(1500))
            .itemOutputs(new ItemStack(ModItems.rune,2,7))
            .noFluidOutputs()
            .eut(RECIPE_EV)
            .duration(20 * 15)
            .addTo(RE);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(new ItemStack(ModItems.rune,4,8))
            .noFluidOutputs()
            .eut(RECIPE_EV)
            .duration(20 * 20)
            .addTo(RE);
        GT_Values.RA.stdBuilder()
            ...
            .fluidInputs(MaterialPool.LiquidMana.getFluidOrGas(3000))
            .itemOutputs(new ItemStack(ModItems.rune,1,9))
            .noFluidOutputs()
            .eut(RECIPE_IV)
            .duration(20 * 10)
            .addTo(RE);
        GT_Values.RA.stdBuilder()
            ...
            .fluidInputs(MaterialPool.LiquidMana.getFluidOrGas(3000))
            .itemOutputs(new ItemStack(ModItems.rune,1,10))
            .noFluidOutputs()
            .eut(RECIPE_IV)
            .duration(20 * 10)
            .addTo(RE);
        GT_Values.RA.stdBuilder()
            ...
            .fluidInputs(MaterialPool.LiquidMana.getFluidOrGas(3000))
            .itemOutputs(new ItemStack(ModItems.rune,1,11))
            .noFluidOutputs()
            .eut(RECIPE_IV)
            .duration(20 * 10)
            .addTo(RE);
        GT_Values.RA.stdBuilder()
            ...
            .fluidInputs(MaterialPool.LiquidMana.getFluidOrGas(3000))
            .itemOutputs(new ItemStack(ModItems.rune,1,12))
            .noFluidOutputs()
            .eut(RECIPE_IV)
            .duration(20 * 10)
            .addTo(RE);
        GT_Values.RA.stdBuilder()
            ...
            .fluidInputs(MaterialPool.LiquidMana.getFluidOrGas(3000))
            .itemOutputs(new ItemStack(ModItems.rune,1,13))
            .noFluidOutputs()
            .eut(RECIPE_IV)
            .duration(20 * 10)
            .addTo(RE);
        GT_Values.RA.stdBuilder()
            ...
            .fluidInputs(MaterialPool.LiquidMana.getFluidOrGas(3000))
            .itemOutputs(new ItemStack(ModItems.rune,1,14))
            .noFluidOutputs()
            .eut(RECIPE_IV)
            .duration(20 * 10)
            .addTo(RE);
        GT_Values.RA.stdBuilder()
            ...
            .fluidInputs(MaterialPool.LiquidMana.getFluidOrGas(3000))
            .itemOutputs(new ItemStack(ModItems.rune,1,15))
            .noFluidOutputs()
            .eut(RECIPE_IV)
            .duration(20 * 10)
            .addTo(RE);

...
public class MegaUniversalSpaceStationRecipePool implements IRecipePool {
    ...
    ItemStack[] processor = new ItemStack[] { ItemList.Circuit_Processor.get(16),
    ...
    ItemStack[] uevPlusCircuit = new ItemStack[] { ItemList.Circuit_ExoticProcessor.get(8),
    ...
    ItemStack[] highDimensionalItem = new ItemStack[] { GTCMItemList.HighDimensionalCapacitor.get(64),

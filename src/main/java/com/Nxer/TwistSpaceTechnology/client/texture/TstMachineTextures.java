...
public enum TstMachineTextures implements IIconContainer {
    ...
    OVERLAY_FRONT_PROCESSING_ARRAY("iconSets/OVERLAY_FRONT_PROCESSING_ARRAY"),
    OVERLAY_FRONT_PROCESSING_ARRAY_ACTIVE("iconSets/OVERLAY_FRONT_PROCESSING_ARRAY_ACTIVE"),

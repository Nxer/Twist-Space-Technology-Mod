...
public class StatsDefination {
    ...
    public final static ArrayList <String> AllStats= new ArrayList<String>(Arrays.asList("Strength", "Intelligence", "CritChance", "CritDamage", "Resistance","BaseDamage", "BaseDamageMultipiler", "MeleeDamageMultipiler",
        "RangeDamageMultipiler", "MagicDamageMultipiler" ));
}

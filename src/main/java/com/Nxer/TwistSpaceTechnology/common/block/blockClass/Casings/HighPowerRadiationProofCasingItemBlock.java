...
public class HighPowerRadiationProofCasingItemBlock extends ItemBlockBase01 {

    public HighPowerRadiationProofCasingItemBlock(Block aBlock) {
        super(aBlock);
    ...
    public void addInformation(ItemStack aItemStack, EntityPlayer p_77624_2_, List theTooltipsList,
        ...
        theTooltipsList.addAll(Arrays.asList(TextLocalization.Tooltips_HighPowerRadiationProofCasing));

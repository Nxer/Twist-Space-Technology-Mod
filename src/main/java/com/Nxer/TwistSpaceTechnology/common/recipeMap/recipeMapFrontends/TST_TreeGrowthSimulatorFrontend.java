    ...
    public List<String> handleNEIItemTooltip(ItemStack stack, List<String> currentTip,
        ...
        for (var input : neiCachedRecipe.mInputs) {
            ...
            if (positionedStack.isFluid()) {
                currentTip.add(EnumChatFormatting.YELLOW + TSTUtils.tr("EcoSphereSimulator.nei.arboreal.medium"));
                ...
                if (neiCachedRecipe.mRecipe.mFluidInputs.length > 0
                    ...
                    currentTip
                        .add(EnumChatFormatting.YELLOW + TSTUtils.tr("EcoSphereSimulator.nei.arboreal.anySapling"));
        ...
        for (var output : neiCachedRecipe.mOutputs) {
            if (!(output instanceof GTNEIDefaultHandler.FixedPositionedStack positionedStack)
                || !guiRecipe.isMouseOver(positionedStack, 0)) continue;
            currentTip.add(EnumChatFormatting.YELLOW + TSTUtils.tr("EcoSphereSimulator.nei.arboreal.selection")

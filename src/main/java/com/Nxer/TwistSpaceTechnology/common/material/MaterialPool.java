...
public class MaterialPool implements Runnable {
    ...
    // public static final Werkstoff NeutroniumAlloy = new Werkstoff(
    // new short[] { 217, 220, 203 },
    // "Neutronium Alloy",
    // subscriptNumbers("Nt11(Ad5Nq2La3)2DuFl҉"),
    // new Werkstoff.Stats().setMass(14400)
    // .setMeltingPoint(12000)
    // .setBlastFurnace(true)
    // .setSpeedOverride(32.0F)
    // .setDurOverride(98304000)
    // .setQualityOverride((byte) 18)
    ...
    public static final Werkstoff AxonisAlloy = new Werkstoff(
        new short[] { 243, 45, 27 },
        "Axonis Alloy",
        subscriptNumbers("۞5(Hy⚶)3⸎2(IcMa)TbSh" + CharExchanger.shifter(9191)),
        new Werkstoff.Stats().setMass(14400)
            .setMeltingPoint(13200)
            .setBlastFurnace(true)
            .setSpeedOverride(480.0F)
            .setDurOverride(786432000)
            .setQualityOverride((byte) 28)
            .disableAutoGeneratedBlastFurnaceRecipes()
            .disableAutoGeneratedVacuumFreezerRecipes(),
        Werkstoff.Types.MIXTURE,
        new Werkstoff.GenerationFeatures().onlyDust()
    ...
    public static final Werkstoff Axonium = new Werkstoff(
        new short[] { 243, 45, 27 },
        "Axonium",
        new Werkstoff.Stats(),
        Werkstoff.Types.ELEMENT,

...
public class UITextures {
    ...
    public static final UITexture SBF_Blaze_Forbidden = UITexture
        .fullImage(TST_ID, "icons/UITextures/SBF_Blaze_Forbidden");
    ...
    public static final UITexture SBF_RapidHeating_Off = UITexture
        .fullImage(TST_ID, "icons/UITextures/SBF_RapidHeating_Off");
    public static final UITexture SBF_RapidHeating_On = UITexture
        .fullImage(TST_ID, "icons/UITextures/SBF_RapidHeating_On");
    public static final UITexture SBF_HoldingHeat_Forbidden = UITexture
        .fullImage(TST_ID, "icons/UITextures/SBF_HoldingHeat_Forbidden");
    public static final UITexture SBF_HoldingHeat_Off = UITexture
    ...
    public static final UITexture ME_STORAGE_CELL = UITexture.fullImage(TST_ID, "icons/UITextures/me_storage_cell");

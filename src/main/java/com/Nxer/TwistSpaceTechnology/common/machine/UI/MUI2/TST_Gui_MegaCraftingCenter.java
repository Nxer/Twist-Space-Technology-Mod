...
public class TST_Gui_MegaCraftingCenter extends TST_Gui<TST_MegaCraftingCenter> {
    ...
    protected Flow createLeftPanelGapRow(ModularPanel parent, PanelSyncManager syncManager) {
        return super.createLeftPanelGapRow(parent, syncManager)
                    .child(createParallelismButton(syncManager, parent));
        ...
        return new ModularPanel("magnificationPanel").relative(parent)
                                             ...
                                             .child(
                                                 Flow.column()
                                                     ...
                                                     .child(
                                                         new TextWidget<>(
                                                             EnumChatFormatting.UNDERLINE + StatCollector.translateToLocal("MegaCraftingCenter.UI.MagnificationInfoMenuButton.name"))
    ...
    public IWidget makeParallelSetter(PanelSyncManager syncManager) {
        ...
        return Flow.row()
                   ...
                   .child(
                       makeParallelConfiguratorTextFieldWidget(magnificationPanelSyncer));
    }

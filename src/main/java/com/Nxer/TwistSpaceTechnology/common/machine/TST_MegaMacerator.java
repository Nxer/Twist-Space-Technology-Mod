...
public class TST_MegaMacerator extends GTCM_MultiMachineBase<TST_MegaMacerator> {
    ...
    private final String[][] shape = new String[][]{
        ...
        {"      DDDDD      ","    DDDDDDDDD    ","   DDDDDDDDDDD   ","  DDDDDDDDDDDDD  "," DDDDDDDDDDDDDDD "," DDDDCDDDDDCDDDD ","DDDDDDDDDDDDDDDDD","DDDDDDDDDDDDDDDDD","DDDDDDDDCDDDDDDDD","DDDDDDDDDDDDDDDDD","DDDDDDDDDDDDDDDDD"," DDDDCDDDDDCDDDD "," DDDDDDDDDDDDDDD ","  DDDDDDDDDDDDD  ","   DDDDDDDDDDDD  ","    DDDDDDDDD    ","      DDDDD      "},

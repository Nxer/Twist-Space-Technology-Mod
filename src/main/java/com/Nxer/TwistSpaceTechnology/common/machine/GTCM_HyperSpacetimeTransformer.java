...
public class GTCM_HyperSpacetimeTransformer extends GTCM_MultiMachineBase<GTCM_HyperSpacetimeTransformer> {
    ...
    public IStructureDefinition<GTCM_HyperSpacetimeTransformer> getStructureDefinition() {
        if (STRUCTURE_DEFINITION == null) {
            STRUCTURE_DEFINITION = StructureDefinition.<GTCM_HyperSpacetimeTransformer>builder()
                ...
                .addElement(
                    'A',
                    HatchElementBuilder.<GTCM_HyperSpacetimeTransformer>builder()
                ...
                .addElement('G', ofBlock(ModBlocks.blockCasings4Misc, 4))
                .addElement(
                    'H',
                    withChannel(
                        "manipulator",
                ...
                .addElement(
                    ...
                    withChannel(
                        ...
                        ofBlocksTiered(
                            ...
                            m -> m.mFocusingTier)))
                .addElement('J', ofBlockAnyMeta(INSTANCE))
                .build();
        }
    ...
    public static final UITexture[] tMachineModeIcons = new UITexture[] {
        GTGuiTextures.OVERLAY_BUTTON_MACHINEMODE_PACKAGER, GTGuiTextures.OVERLAY_BUTTON_MACHINEMODE_UNPACKAGER };
    ...
    public static int getBlockFieldGeneratorTier(Block block, int meta) {
        if (block == SpacetimeCompressionFieldGenerators || block == TimeAccelerationFieldGenerator
            || block == StabilisationFieldGenerators) return meta + 1;
        return 0;
    }

    public static int getBlockTier(Block block, int meta) {
        if (block == ModBlocks.blockCasings5Misc) return (meta + 1) % 4 + 1;
        return 0;
    }

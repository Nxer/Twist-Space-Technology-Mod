...
import static gregtech.api.modularui2.GTGuiTextures.BUTTON_STANDARD_PRESSED;
...
public class TST_Gui_SwelegfyrBlastFurnace extends TST_Gui<TST_SwelegfyrBlastFurnace>{
    ...
    public IWidget createRapidHeatingButton(PanelSyncManager syncManager) {
        ...
        BooleanSyncValue rapidHeatingButtonSyncer = (BooleanSyncValue) syncManager.getSyncHandlerFromMapKey("rapidHeatingButtonSyncer:0");
        BooleanSyncValue updatedMachineGetter = (BooleanSyncValue) syncManager.getSyncHandlerFromMapKey("updatedMachineGetter:0");
    ...
    public IWidget createHoldingHeatButton(PanelSyncManager syncManager) {
        IntSyncValue machineModeSyncer = (IntSyncValue) syncManager.getSyncHandlerFromMapKey("machineMode:0");
        BooleanSyncValue updatedMachineGetter = (BooleanSyncValue) syncManager.getSyncHandlerFromMapKey("updatedMachineGetter:0");
        BooleanSyncValue holdingHeatButtonSyncer = (BooleanSyncValue) syncManager.getSyncHandlerFromMapKey("holdingHeatButtonSyncer:0");
    ...
    protected void registerSyncValues(PanelSyncManager syncManager) {
        ...
        BooleanSyncValue updatedMachineGetter = new BooleanSyncValue(
            () -> multiblock.controllerTier != 2
        );
